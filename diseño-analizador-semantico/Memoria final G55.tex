...
El trabajo ha sido realizado con la herramienta o librería externa "SLY" \cite{SLY}.\\
...
\begin{myitemize}
    ...
    \item Cadenas: Con comillas dobles (\textbf{" "})
\end{myitemize}
\clearpage
...
\noindent
Axioma = A\\
A $\rightarrow$ del A $|$ d D $|$ " S $|$ / C $|$ l I $|$ \minus  M $|$ = E $|$ \& N $|$ ( $|$ ) $|$ \{ $|$ \} $|$ ; $|$ , \\
...
\begin{flushleft}
    ...
    \qquad \quad \quad      pError("Identificador ya declarado")\\
    \qquad \quad        else\\
